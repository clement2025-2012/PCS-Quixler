// ============================================================
// PCS Academy Quiz Application — MASTER ENGINE v40.0
...
class PCSQuizApp {
    ...
    startQuiz() {
        ...
        this.score = 0;
        this.userAnswers = [];
        // Randomly select 10 questions from the 40 question bank
    ...
    submitAnswer() {
        ...
        exp.innerHTML = `<span style="color:${isCorrect ? 'var(--success)' : 'var(--error)'}; font-size:1.3rem; font-weight:800; display:block; margin-bottom:5px;">${isCorrect ? '✓ Excellent!' : '✗ Not quite.'}</span><span style="color:var(--gray-700); font-size:1rem; line-height:1.5;">${q.explanation}</span>`;
